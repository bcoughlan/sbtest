...
{ 
    ...
    { 
        ...
        [HttpDelete]
        [Route("/virts/admin/Sel_API_4128392/1.0.0/store/order/{orderId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/virts/admin/Sel_API_4128392/1.0.0/store/inventory")]
        ...
        [HttpPost]
        [Route("/virts/admin/Sel_API_4128392/1.0.0/store/order")]
        [ValidateModelState]
